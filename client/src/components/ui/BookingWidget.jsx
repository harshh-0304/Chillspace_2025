...
// const BookingWidget = ({ place, onBookNow }) => {
//   const [dateRange, setDateRange] = useState({ from: null, to: null });
//   const [bookingData, setBookingData] = useState({
//     noOfGuests: 1,
//     name: '',
...
//     // Instead of redirecting to booking page, trigger payment flow
//     if (onBookNow) {
//       // Pass booking details to the payment component
//       onBookNow({
//         checkIn: dateRange.from,
//         checkOut: dateRange.to,
//         noOfGuests,
...
//       });
//     } else {
//       // Fallback to original behavior if onBookNow not provided
//       try {
//         const response = await axiosInstance.post('/bookings', {
//           checkIn: dateRange.from,
//           checkOut: dateRange.to,
...
const BookingWidget = ({ place, onBookNow }) => {
  ...
  const handleBooking = async () => {
    ...
    // Prepare booking data to pass to payment component
    ...
    // Trigger the payment process if onBookNow is provided
    if (onBookNow) {
      ...
      try {
        const response = await axiosInstance.post('/bookings', {
          ...bookingDetails,
          paymentStatus: 'not_required' // For direct bookings without payment
        });
